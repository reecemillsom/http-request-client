...
describe("FetchRequest", function () {
    ...
    describe("when asked to fetch", function () {
        ...
        describe("when ok is valid", function () {
            describe("when response is json", function () {
                it("will resolve json", function () {
                    windowMock.isFetchFine = true;
            ...
            describe("when response is not json", function () {
                it("will resolve the whole response", function () {
                    windowMock.isFetchFine = true;
                    windowMock.jsonContent = "some text";
                    return fetchRequest.handleRequest("mockurl/ok", {}).then(function (result) {
                        chai_1.expect(result).to.contain({
                            ok: true,
                            status: 200,
                        });
                    });
